...
use Webkul\Shop\Http\Middleware\Theme as ShopThemeMiddleware;
...
return [
    ...
    'title' => 'Shop API Documentation (Mobile)',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API for mobile applications: catalog, categories, products, cart, checkout, customer profile, wishlist.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Customer endpoints use <b>session-based authentication</b>. Call <code>POST /api/customer/login</code> with <code>email</code> and <code>password</code> in the body. The response sets session cookies; include them (with credentials) in subsequent requests for protected endpoints (addresses, wishlist).',
    ],
