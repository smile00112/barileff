...
return [
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    'info' => 'تنظیم عنوان پیشنهاد هدر و اسکریپت‌های سفارشی.',
                    'title' => 'محتوا',
                ...
                'design' => [
                    'info' => 'تنظیم لوگو و آیکون فاویکون برای پنل مدیریت.',
                    'title' => 'طراحی',
            ...
            'customer' => [
                ...
                'settings' => [
                    'settings-info' => 'تنظیم لیست علاقه‌مندی‌ها، هدایت ورود، اشتراک‌های خبرنامه، گزینه گروه پیش‌فرض، تأیید ایمیل و ورود اجتماعی.',
                    'title' => 'تنظیمات',
                    ...
                    'social-login' => [
                        ...
                        'info' => '"ورود با شبکه‌های اجتماعی" به کاربران اجازه می‌دهد با استفاده از حساب‌های شبکه‌های اجتماعی خود وارد وب‌سایت شوند و فرآیند ثبت‌نام و ورود را ساده‌تر می‌کند.',
                        ...
                        'twitter' => [
                            ...
                            'client-id' => [
                                'title' => 'شناسه کلاینت (Client ID)',
                                'title-info' => 'شناسه منحصربه‌فردی که هنگام ایجاد برنامه OAuth توسط توییتر ارائه می‌شود.',
                            ],

                            'client-secret' => [
                                'title' => 'رمز کلاینت (Client Secret)',
                                'title-info' => 'کلید محرمانه مرتبط با کلاینت OAuth توییتر شما. آن را محرمانه نگه دارید.',
                            ],
            ...
            'email' => [
                ...
                'notifications' => [
                    ...
                    'info' => 'برای پیکربندی، دریافت ایمیل‌های تأیید حساب، تأیید سفارش، به‌روزرسانی فاکتورها، بازپرداخت‌ها، ارسال‌ها و لغو سفارش‌ها.',
    ...
    'footer' => [
        'copy-right' => 'قدرت گرفته از <a href="https://bagisto.com/" target="_blank">Sinica</a>، یک پروژه اجتماعی توسط <a href="https://webkul.com/" target="_blank">Webkul</a>',
    ],
