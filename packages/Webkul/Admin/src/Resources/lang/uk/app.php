...
return [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'copyright-content' => [
                        ...
                        'info' => 'Налаштуйте вміст авторських прав, що відображається в нижньому колонтитулі вашого вебсайту, щоб захистити вашу інтелектуальну власність та підвищити впізнаваність бренду.',
                    ],
                ...
                'settings' => [
                    ...
                    'social-login' => [
                        ...
                        'twitter' => [
                            ...
                            'redirect' => [
                                'title' => 'URL для перенаправлення',
                                'title-info' => 'URL-адреса, на яку користувачі будуть перенаправлені після аутентифікації через Twitter. Використовуйте показаний формат URL-заповнювача (змініть лише ваш домен). Вона повинна збігатися з URL, налаштованим у вашій консолі Twitter.',
                            ],
                        ],
                    ],
                ],
    ...
    'footer' => [
        'copy-right' => 'Працює на платформі <a href="https://bagisto.com/" target="_blank">Sinica</a>, Спільний проект <a href="https://webkul.com/" target="_blank">Webkul</a>',
    ],
