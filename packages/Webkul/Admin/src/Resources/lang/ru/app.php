...
return [
    ...
    'catalog' => [
        ...
        'imports' => [
            'index' => [
                'button-new' => 'Новый импорт',
                'button-delete-selected' => 'Удалить выбранные',
                'confirm-mass-delete' => 'Удалить выбранные сессии импорта? Это действие нельзя отменить.',
                'delete-confirm' => 'Удалить эту сессию импорта? Это действие нельзя отменить.',
                'delete-failed' => 'Не удалось удалить сессию импорта.',
                'delete-processing-not-allowed' => 'Нельзя удалить импорт во время обработки. Дождитесь завершения или ошибки.',
                'delete-success' => 'Сессия импорта удалена.',
                'description' => 'Используйте эту страницу для импорта данных каталога из подготовленных файлов.',
                'mass-delete-success' => 'Выбранные сессии импорта удалены.',
                'no-records' => 'Импортов ещё нет.',
                'title' => 'Импорт данных',
            ...
            'upload' => [
                'back-btn' => 'Назад',
                'submit' => 'Загрузить и продолжить',
                'success' => 'Файл загружен. Пожалуйста, настройте маппинг столбцов.',
                ...
                'fields' => [
                    ...
                    'file' => 'CSV-файл',
                    'file-hint' => 'Допустимые форматы: .csv, .txt  •  Макс. 50 МБ',
                    'locale' => 'Язык импорта',
                    'locale-hint' => 'Язык для текстовых атрибутов (название, описание и т.д.)',
                    'options-title' => 'Параметры импорта',
                    'allow-insert' => 'Добавлять новые товары',
                    'allow-insert-hint' => 'Создавать товары, SKU которых ещё нет в каталоге.',
                    'allow-update' => 'Обновлять существующие товары',
                    'allow-update-hint' => 'Обновлять товары, SKU которых уже есть в каталоге.',
                    'new-products-active' => 'Делать новые товары активными',
                    'new-products-active-hint' => 'Новые товары (SKU которых нет в каталоге) будут импортированы со статусом «Активен». Снимите флажок, чтобы импортировать их неактивными.',
                    'new-products-in-stock' => 'Учитывать остаток новых товаров на складе',
                    'new-products-in-stock-hint' => 'Новые товары будут импортированы с количеством из файла. Снимите флажок, чтобы они появились с qty=0 (нет в наличии).',
                    'create-categories' => 'Создавать отсутствующие категории',
                    'create-categories-hint' => 'Автоматически создавать категории из CSV, которых ещё нет в каталоге. Несколько имён через запятую в одной ячейке задают путь: первое — дочерняя к выбранному ниже родителю, каждое следующее — дочерняя к предыдущей.',
                    'parent-category' => 'Родительская категория для новых категорий',
                    'parent-category-hint' => 'Первое имя в пути через запятую создаётся под этой категорией; каждый следующий уровень вкладывается в предыдущий.',
                ],

                'validation' => [
                    'file-csv-only' => 'Принимаются только файлы формата CSV / TXT.',
                    'file-invalid-encoding' => 'Файл должен быть в кодировке UTF-8.',
                    'file-required' => 'Пожалуйста, выберите файл.',
                    'file-too-large' => 'Размер файла не должен превышать 50 МБ.',
                    'file-unreadable' => 'Не удалось прочитать файл. Попробуйте загрузить его повторно.',
                ],
            ],
            ...
            'show' => [
                ...
                'csv-preview' => 'Пример данных',
                'csv-preview-empty' => 'пусто — проверьте данные',
                ...
                'sku-required' => 'Необходимо назначить хотя бы один столбец полю SKU.',
                'start-import' => 'Запустить импорт',
                'step-import' => 'Обработка',
                'step-mapping' => 'Маппинг столбцов',
                'step-result' => 'Результат',
                'summary-created' => 'Создано',
                'summary-deleted' => 'Удалено',
            ...
            'errors' => [
                'cannot-modify' => 'Невозможно изменить уже запущенный импорт.',
                'csv-reformat-failed' => 'Не удалось создать переформатированный CSV-файл.',
                'generic' => 'Произошла ошибка. Попробуйте ещё раз.',
                'map-first' => 'Сохраните маппинг столбцов перед запуском импорта.',
                'not-ready' => 'Сессия импорта не готова к запуску.',
                'validation-failed' => 'Файл импорта не прошёл проверку.',
            ],
        ],
    ],
    ...
    'settings' => [
        ...
        'delivery_zones' => [
            ...
            'zones' => [
                'manage-title' => 'Управление зонами доставки',
                'city-label' => 'Город',
                'back-to-cities' => 'К списку городов',
                'edit-city' => 'Редактировать город',
                'city-zones' => 'Зоны города',
                'add-new-zone' => 'Добавить зону',
                'empty-zones' => 'Зон пока нет. Создайте первую зону для этого города.',
                'zones-map' => 'Карта зон',
                'edit-selected-zone' => 'Редактировать выбранную зону',
                'new-zone' => 'Новая зона',
                'cancel' => 'Отмена',
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'maintenance-excluded-paths' => 'Разрешённые пути при обслуживании',
                'maintenance-excluded-paths-info' => 'Пути через запятую (например api/*, page/*, paypal/*), доступные при включённой заглушке: Shop API, CMS-страницы, callback платёжных систем.',
                'maintenance-excluded-paths-placeholder' => 'api/*, page/*, paypal/*',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'category-grid' => 'Сетка Категорий',
                    'category-nested-grid' => 'Вложенная сетка категорий',
            ...
            'edit' => [
                ...
                'category-grid' => 'Сетка Категорий',
                'category-grid-description' => 'Отображение категорий в адаптивной сетке с настраиваемым количеством колонок и возможностью показать название.',
                'category-nested-grid' => 'Вложенная сетка категорий',
                'category-nested-grid-description' => 'Категории первого уровня — заголовки; под каждой их подкатегории второго уровня в виде сетки.',
                ...
                'limit' => 'Лимит',
                'link' => 'Ссылка',
                'desktop-columns' => 'Колонок на Desktop',
                'mobile-columns' => 'Колонок на Mobile',
                'name' => 'Название',
                'new' => 'Новый',
                'no' => 'Нет',
                ...
                'status' => 'Статус',
                'show-category-name' => 'Показывать название категории',
                'themes' => 'Темы',
        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'copyright-content' => [
                        ...
                        'info' => 'Настройте содержимое авторских прав, отображаемое в нижнем колонтитуле вашего сайта, чтобы защитить вашу интеллектуальную собственность и повысить узнаваемость бренда.',
                    ],
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'settings' => [
                        ...
                        'filter-categories-by-stock' => 'Фильтровать категории по наличию товаров',
                        'filter-categories-by-stock-info' => 'Если включено, отображаются только категории, в которых есть товары в наличии на выбранном складе.',
                    ...
                    'category-image' => [
                        'auto-height' => 'Авто высота (сохранять пропорции)',
                        'title' => 'Изображение категории',
                        'title-info' => 'При включении изображения категорий масштабируются только по ширине, высота рассчитывается автоматически с сохранением исходного соотношения сторон.',
                    ],
                ...
                'settings' => [
                    ...
                    'social-login' => [
                        ...
                        'twitter' => [
                            ...
                            'redirect' => [
                                'title' => 'URL перенаправления',
                                'title-info' => 'URL-адрес для обратного вызова, на который пользователи будут перенаправлены после аутентификации через Twitter. Используйте показанный формат URL-заполнителя (измените только ваш домен). Он должен соответствовать URL, настроенному в вашей консоли Twitter.',
                            ],
                        ],
                    ],
                ],
            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'delivery-zones' => [
                        'welcome-modal-active' => 'Показывать приветственный модал с выбором города',
                        'welcome-modal-text' => 'Текст приветственного модала',
                        'detect-city-by-ip' => 'Определять город по IP посетителя',
                    ],
                ],
                ...
                'payment-methods' => [
                    ...
                    'payment-with-confirmation' => 'Оплата с подтверждением',
                    'payment-with-confirmation-info' => 'Клиент оплачивает переводом или другим офлайн-способом и загружает чек; заказ завершается после проверки менеджером.',
    ...
    'acl' => [
        ...
        'attributes' => 'Атрибуты',
        'campaigns' => 'Кампании',
        'catalog-imports' => 'Импорт данных каталога',
        'cancel' => 'Отмена',
