        ...
        'index' => [
            ...
            'sales' => [
                ...
                'order-settings' => [
                    ...
                    'status-transitions' => [
                        'enable' => 'Применять правила переходов статусов',
                        'enable-info' => 'Если включено — смена статуса заказа разрешена только по правилам из таблицы переходов. Если отключено — любой переход в активный статус возможен.',
                        'info' => 'Управляет тем, проверяет ли система правила переходов при смене статуса заказа.',
                        'title' => 'Правила переходов статусов',
                    ],
