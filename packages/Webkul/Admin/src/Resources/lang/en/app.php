    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'status-update-confirm' => 'Are you sure you want to update the order status?',
                'status-update-fail' => 'Unable to update the order status.',
    ...
    'catalog' => [
        ...
        'imports' => [
            ...
            'mapping' => [
                ...
                'inventory-source-hint' => 'When a qty column is mapped, its values will be assigned to this inventory source as "source_code=qty".',
                'inventory-source-label' => 'Inventory Source',
                'inventory-source-placeholder' => '— No source selected (use inventories column format) —',
                'saved' => 'Mapping saved.',
    ...
    'settings' => [
        ...
        'delivery_zones' => [
            'edit' => [
                ...
                'polygon-fill-opacity' => 'Polygon Fill Opacity',
            ...
            'zones' => [
                'manage-title' => 'Manage Delivery Zones',
                'city-label' => 'City',
                'back-to-cities' => 'Back To Cities',
                'edit-city' => 'Edit City',
                'city-zones' => 'City Zones',
                'add-new-zone' => 'Add New Zone',
                'empty-zones' => 'No zones yet. Create the first zone for this city.',
                'zones-map' => 'Zones Map',
                ...
                'save-zone' => 'Save Zone',
                'edit-zone-title' => 'Edit Zone: :name',
                'delete-zone-confirm' => 'Delete this zone?',
                'invalid-polygon-json' => 'Invalid JSON in Polygon JSON field.',
                'polygon-must-be-array' => 'Polygon JSON must be an array of coordinates.',
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'maintenance-excluded-paths' => 'Excluded Paths During Maintenance',
                'maintenance-excluded-paths-info' => 'Comma-separated path patterns (e.g. api/*, page/*, paypal/*) that remain accessible when maintenance is on. Used for webview, Shop API, CMS pages, and payment callbacks.',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'order-settings' => [
                    ...
                    'status-transitions' => [
                        'enable' => 'Enforce Status Transition Rules',
                        'enable-info' => 'When enabled, order status changes are restricted to rules configured in the transition table. Disable to allow any status change freely.',
                        'info' => 'Control whether the system enforces the order status transition rules.',
