...
@pushOnce('scripts')
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.settings.themes.edit.category-grid')"
                    >
    ...
    <script type="module">
        app.component('v-category-grid', {
            template: '#v-category-grid-template',
