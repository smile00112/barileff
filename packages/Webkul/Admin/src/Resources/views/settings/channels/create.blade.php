            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.settings.channels.create.maintenance-excluded-paths')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                :value="old('maintenance_excluded_paths')"
                                :label="trans('admin::app.settings.channels.create.maintenance-excluded-paths')"
                                :placeholder="trans('admin::app.settings.channels.create.maintenance-excluded-paths-placeholder')"
                            />

                            <p class="mt-1 text-xs text-gray-600 dark:text-gray-400">
                                @lang('admin::app.settings.channels.create.maintenance-excluded-paths-info')
                            </p>
