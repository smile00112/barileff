...
class OrderShipmentDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('shipments')
            ->where('shipments.is_system', false)
            ...
            ->selectRaw(DbHelper::ifExpression(DB::getTablePrefix().'shipments.inventory_source_id IS NOT NULL', DB::getTablePrefix().'inventory_sources.name', DB::getTablePrefix().'shipments.inventory_source_name').' as inventory_source_name');
        ...
        $this->addFilter('inventory_source_name', DB::raw(DbHelper::ifExpression(DB::getTablePrefix().'shipments.inventory_source_id IS NOT NULL', DB::getTablePrefix().'inventory_sources.name', DB::getTablePrefix().'shipments.inventory_source_name')));
