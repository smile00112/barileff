...
return [
    ...
    [
        ...
        'key' => 'sales.carriers.delivery_zones',
        'name' => 'Delivery By Zones',
        'info' => 'Zone-based shipping method',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'title',
        ...
        'key' => 'sales.payment_methods.paymentconfirmation',
        'name' => 'admin::app.configuration.index.sales.payment-methods.payment-with-confirmation',
        'info' => 'admin::app.configuration.index.sales.payment-methods.payment-with-confirmation-info',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'title',
