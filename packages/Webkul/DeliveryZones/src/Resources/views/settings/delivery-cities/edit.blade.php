<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.settings.delivery_zones.cities-edit.title')
    </x-slot>

    <x-admin::form :action="route('admin.settings.delivery_cities.update', $deliveryCity->id)" method="PUT">
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            <p class="text-xl font-bold text-gray-800 dark:text-white">
                @lang('admin::app.settings.delivery_zones.cities-edit.heading')
            </p>
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                <a href="{{ route('admin.settings.delivery_cities.zones', $deliveryCity->id) }}" class="secondary-button">
                    @lang('admin::app.settings.delivery_zones.cities-edit.manage-zones')
                </a>
