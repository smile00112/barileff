...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Авторское право 2022 - :current_year, Sinica Software. Все права защищены.',
    ...
    'delivery-zones' => [
        'zone-not-found' => 'Зона доставки для выбранного адреса не найдена.',
        ...
        'welcome-modal' => [
            'title' => 'Выберите свой город для доставки',
            'select-city' => 'Выберите город:',
            'specify-address' => 'Указать адрес доставки',
            'close' => 'Позже',
            'detected' => '(определено)',
        ],
    ],
    ...
    'checkout' => [
        ...
        'onepage' => [
            'address' => [
                ...
                'back' => 'Назад',
                'billing-address' => 'Заполните для заказа',
                'check-billing-address' => 'Отсутствует адрес выставления счета.',
                'check-shipping-address' => 'Отсутствует адрес доставки.',
                'delivery-address' => 'Адрес доставки',
                'no-delivery-zone' => 'Пожалуйста, сначала выберите адрес доставки.',
                'select-delivery-zone' => 'Выбрать на карте',
                'city' => 'Город',
                'company-name' => 'Название компании',
                'confirm' => 'Подтвердить',
                'country' => 'Страна',
    ...
    'emails' => [
        ...
        'customers' => [
            'account-created' => [
                'credentials-description' => 'Ваши данные для входа указаны ниже:',
                'description' => 'При оформлении заказа для вас автоматически создан аккаунт. Используйте приведённые данные для входа и управления заказами.',
                'greeting' => 'Ваш аккаунт готов!',
                'password' => 'Пароль',
                'sign-in' => 'Войти',
