...
namespace Webkul\ImportExport\Http\Controllers\Admin\DataTransfer;
...
use Webkul\ImportExport\DataGrids\ImportDataGrid;
...
class ImportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('import_export::admin.data-transfer.imports.index');
    }
    ...
    {
        return view('import_export::admin.data-transfer.imports.create', [
    ...
    {
        return view('import_export::admin.data-transfer.imports.edit', [
    ...
    public function import(int $id)
    {
        ...
        return view('import_export::admin.data-transfer.imports.import', compact('import', 'isValid', 'stats'));
    }
